...
const CalendarSocial = lazy(() =>
  import("./views/apps/usermanage/calendar/CalendarSocial")
);
const UserListView = lazy(() =>
  import("./views/apps/usermanage/user-list/UserListView")
);
const FileGrid = lazy(() =>
  import("./views/apps/usermanage/filegridview/FileGrid")
);
const ProfileGrid = lazy(() =>
  import("./views/apps/usermanage/profilesocial/ProfileFeed")
);
...
const shedulelist = lazy(() => import("./views/apps/shedule/sheduleList"));
const filemanagerlist = lazy(() =>
  import("./views/apps/FileManager/FileManagerList")
);
const FacebookPage = lazy(() => import("../src/views/pages/FacebookPage"));
...
const Loginnew = lazy(() =>
  import("./views/pages/authentication/login/SocialLogin")
);
    ...
    return (
      ...
      <Router history={history}>
        <Switch>
          ...
          <AppRoute path="/shedule/shedulelist" component={shedulelist} />
          <AppRoute
          ...
          />
          <AppRoute path="/FacebookPage" component={FacebookPage} />
          ...
          <AppRoute path="/pages/loginnew" component={Loginnew} fullLayout />
